    ...
    <footer className="bg-gray-900 text-gray-400 py-12 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
          ...
          {/* Maison Préfabriquée */}
          <div>
            <h4 className="text-white font-bold mb-4">Maison Préfabriquée</h4>
            <ul className="space-y-2 text-sm">
          ...
          {/* Container */}
          <div>
            <h4 className="text-white font-bold mb-4">Container</h4>
            <ul className="space-y-2 text-sm">
          ...
          {/* Cabine Modulaire */}
          <div>
            <h4 className="text-white font-bold mb-4">Cabine Modulaire</h4>
            <ul className="space-y-2 text-sm">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          {/* Blog */}
          <div>
            <h4 className="text-white font-bold mb-4">Blog</h4>
            <ul className="space-y-2 text-sm">
        ...
        <div className="text-center border-t border-gray-800 pt-8">
          <p className="text-sm text-gray-500 mb-2">1986 - 2025 © Tous droits réservés. UNIHOME Technologies de Construction Préfabriquée.</p>
          <p className="text-sm text-gray-600">Toutes les images et textes présents sur notre site sont la propriété de notre entreprise et leur utilisation sans autorisation écrite est strictement interdite.</p>
          <div className="flex justify-center items-center flex-wrap gap-4 md:gap-6 mt-6">
            <Link to="/entreprise/mission" className="text-gray-400 hover:text-green-500 transition-colors text-sm">À Propos</Link>
            <Link to="/mentions-legales" className="text-gray-400 hover:text-green-500 transition-colors text-sm">Mentions Légales</Link>
            <Link to="/politique-confidentialite" className="text-gray-400 hover:text-green-500 transition-colors text-sm">Confidentialité</Link>
            <Link to="/politique-cookies" className="text-gray-400 hover:text-green-500 transition-colors text-sm">Cookies</Link>
            <Link to="/cgv" className="text-gray-400 hover:text-green-500 transition-colors text-sm">CGV</Link>
            <Link to="/cgu" className="text-gray-400 hover:text-green-500 transition-colors text-sm">CGU</Link>
            <Link to="/contact" className="text-gray-400 hover:text-green-500 transition-colors text-sm">Contact</Link>
          </div>
        </div>
      </div>
    </footer>
