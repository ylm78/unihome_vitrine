...
interface FooterHomepageStyleProps {
  onContactClick?: () => void;
}

export function FooterHomepageStyle({ onContactClick }: FooterHomepageStyleProps) {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li><Link to="/#models" className="hover:text-green-400 transition-colors">Nos Produits</Link></li>
              <li><Link to="/installations-chantier" className="hover:text-green-400 transition-colors">Installations Chantier</Link></li>
              <li><a href="/#philosophie" className="hover:text-green-400 transition-colors">Notre Philosophie</a></li>
              <li><a href="/#concept" className="hover:text-green-400 transition-colors">Technologie</a></li>
              <li>
                {onContactClick ? (
                  <button onClick={onContactClick} className="hover:text-green-400 transition-colors text-left">Contact</button>
                ) : (
